function Get-WarmerValues ($Temp1){
    $Temp1 = ''
    $Temp2 = ''
    $StatusText = ''
    $TempStart = ''
    ...
    #    $InvRes
    #
    return  @($Temp1, $Temp2, $StatusText, $TempStart, $Hysteresis)
}

$fname = ".\"+(Get-Date -Format "yyyyMMdd") + '.txt'

$res = Get-WarmerValues
$str = (Get-Date -Format G) + "`t" + $res[0] + "`t" + $res[1] + "`t" + $res[2] + "`t" + $res[3] + "`t" + $res[4]
